...
const Register = () => {
  ...
  return (
    <div className="w-full">
      {/* Login Form - 1 */}
      <div className="flex flex-col mx-4 my-4 md:mt-12 sm:mx-auto p-6 max-w-[380px] px-8 border rounded-lg shadow-xl bg-white">
        {/* div 1 */}
        ...
        <div className="flex flex-col gap-4 mt-10">
          ...
          <button onClick={registerUser} className="mt-3 py-4 tracking-wide font-semibold bg-indigo-500 text-gray-100 border rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out">
            Sign In
          </button>
          <ToastContainer />
        </div>
